...
public class GraphDBLauncher {
    ...
    public static void main(String[] args) {
        ...
        // Return an iterable of graph vertices.
        ...
        long vNaive = g.kdTree.nearestNaive(-122.258207, 37.875352);
        System.out.print("Vertex number closest to -122.258207, 37.875352 is " + v + ", which");
        System.out.println(" has longitude, latitude of: " + g.lon(v) + ", " + g.lat(v));
        System.out.print("Vertex number closest to -122.258207, 37.875352 using naive search is "
                + vNaive);
    }
}
